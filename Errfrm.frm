...
Begin VB.Form Errfrm 
   ...
   Begin VB.Frame Frame4 
      BackColor       =   &H00E0E0E0&
      Caption         =   "Would you like to send the error report to developer using email  ?"
      ForeColor       =   &H000000FF&
      Height          =   735
      Left            =   6240
      TabIndex        =   14
   ...
   Begin VB.Frame Frame3 
      BackColor       =   &H00E0E0E0&
      Caption         =   "Please, choose what you will like to do with programme execution ?"
      ForeColor       =   &H000000FF&
      Height          =   735
      Left            =   120
      TabIndex        =   13
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Label Label6 
         BackStyle       =   0  'Transparent
         Caption         =   "If you select to send error info. to the developer this information will be included, with your email. "
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
...
Private Sub Form_Load()
    Dim ctr As Integer
    ctr = 101
    Image1.Picture = LoadResPicture(ctr, vbResBitmap)
End Sub
...
Private Sub SendReport_Click()
    ...
    MsgBox "Now you will be prompted by outlook for confirmation, Click yes to Queue this email", vbInformation, "Info"
...
Private Sub Timer1_Timer()
    ...
    Else
        rid = rid + 1
    End If
    Image1.Picture = LoadResPicture(rid, vbResBitmap)
End Sub
